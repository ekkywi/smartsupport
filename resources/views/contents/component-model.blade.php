...
@section("content")
    <div class="container-fluid">
        ...
        <div class="mb-3 d-flex flex-wrap gap-2">
            <a class="btn btn-success" href="{{ route("component.models.create") }}">
                <i class="ti ti-plus"></i> Tambah Model Komponen
            </a>
            <a class="btn btn-primary" href="{{ route("component.models.trashed") }}">
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered text-nowrap" id="responsiveDataTable" style="width:100%">
                            ...
                            <tbody>
                                @forelse ($componentModels as $componentModel)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-primary" href="{{ route("component.models.edit", $componentModel->id) }}"><i class="ti ti-pencil"></i> Edit</a>
                                            ...
                                            <form action="{{ route("component.models.destroy", $componentModel->id) }}" id="delete-form-{{ $componentModel->id }}" method="POST" style="display: none;">
                                                @csrf
                                                @method("DELETE")
                                            </form>
                                        </td>
