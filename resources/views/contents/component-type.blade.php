...
@section("content")
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Jenis Komponen</h1>
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb breadcrumb-style2 mb-0">
                        <li class="breadcrumb-item">Master Data Aset</li>
                        <li class="breadcrumb-item">Komponen</li>
                        <li aria-current="page" class="breadcrumb-item active">Jenis Komponen</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="mb-3 d-flex flex-wrap gap-2">
            <a class="btn btn-success" href="{{ route("component.types.create") }}">
                <i class="ti ti-plus"></i> Tambah Jenis Komponen
            </a>
            <a class="btn btn-primary" href="{{ route("component.types.trashed") }}">
                                ...
                                @forelse ($componentTypes as $componentType)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route("component.types.destroy", $componentType->id) }}" id="delete-form-{{ $componentType->id }}" method="POST" style="display: none;">
                                                @csrf
                                                @method("DELETE")
                                            </form>
                                        </td>
