...
@section("content")
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Lokasi Aset</h1>
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb breadcrumb-style2 mb-0">
                        <li class="breadcrumb-item">Management Aset</li>
                        <li class="breadcrumb-item">Master Data Aset</li>
                        <li aria-current="page" class="breadcrumb-item active">Model Aset</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="mb-3">
            <a class="btn btn-success" href="{{ route("assets.model.create") }}">
                <i class="ti ti-plus"></i> Tambah Model
            </a>
        </div>
        <div class="row">
            <div class="col-xl-12">
                            ...
                            <tbody>
                                @foreach ($assetModels as $model)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-primary" href="{{ route("assets.model.edit", $model->id) }}"><i class="ti ti-pencil"></i> Edit</a>
                                            <button class="btn btn-sm btn-danger delete-btn" data-model-id="{{ $model->id }}" type="button"><i class="ti ti-trash me-1"></i>
                                                Hapus
                                            </button>
                                            <form action="{{ route("assets.model.destroy", $model->id) }}" id="delete-form-{{ $model->id }}" method="POST" style="display: none;">
                                                @csrf
                                                @method("DELETE")
                                            </form>
                                        </td>
