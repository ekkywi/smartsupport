...
@section("content")
    <div class="container-fluid">
            ...
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb breadcrumb-style2 mb-0">
                        ...
                        <li aria-current="page" class="breadcrumb-item active">Supplier</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="mb-3 d-flex flex-wrap gap-2">
            ...
            <a class="btn btn-primary" href="{{ route("suppliers.trashed") }}">
                            ...
                            <tbody>
                                @forelse ($suppliers as $supplier)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-primary" href="{{ route("suppliers.edit", $supplier->id) }}"><i class="ti ti-pencil"></i> Edit</a>
                                            <button class="btn btn-sm btn-danger delete-btn" data-supplier-id="{{ $supplier->id }}" type="button"><i class="ti ti-trash me-1"></i>
                                                Hapus
                                            </button>
                                            <form action="{{ route("suppliers.destroy", $supplier->id) }}" id="delete-form-{{ $supplier->id }}" method="POST" style="display: none;">
                                                @csrf
                                                @method("DELETE")
                                            </form>
                                        </td>
