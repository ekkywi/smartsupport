...
@section("title")
    SmartSupport &mdash; Lokasi Aset
@endsection
            ...
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb breadcrumb-style2 mb-0">
                        ...
                        <li aria-current="page" class="breadcrumb-item active">Lokasi Aset</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="locationModalLabel">Form Lokasi</h5>
                ...
                <div class="modal-body">
                    <form id="locationForm">
                        ...
                        <input id="locationId" name="id" type="hidden">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $('#formMethod').val('PUT');
                $('#locationModalLabel').text('Edit Lokasi');
                $('#locationModal').modal('show');
            });
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.status === 422) {
                            ...
                            if (err && err.description) {
                                $('#description-error').text(err.description[0]).show();
