...
@section("content")
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Vendor</h1>
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb breadcrumb-style2 mb-0">
                        <li class="breadcrumb-item">Master Data Aset</li>
                        <li class="breadcrumb-item">Supplier dan Vendor</li>
                        <li aria-current="page" class="breadcrumb-item active">Vendor</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="mb-3 d-flex flex-wrap gap-2">
            <a class="btn btn-success" href="{{ route("vendors.create") }}">
                <i class="ti ti-plus"></i> Tambah Vendor
            </a>
            <a class="btn btn-primary" href="{{ route("vendors.trashed") }}">
                            ...
                            <tbody>
                                @forelse ($vendors as $vendor)
                                    <tr>
                                        ...
                                        <td>{{ $vendor->notes }}</td>
                                        <td>
                                            <a class="btn btn-sm btn-primary" href="{{ route("vendors.edit", $vendor->id) }}"><i class="ti ti-pencil"></i> Edit</a>
                                            <button class="btn btn-sm btn-danger delete-btn" data-vendor-id="{{ $vendor->id }}" type="button"><i class="ti ti-trash me-1"></i>
                                                Hapus
                                            </button>
                                            <form action="{{ route("vendors.destroy", $vendor->id) }}" id="delete-form-{{ $vendor->id }}" method="POST" style="display: none;">
                                                @csrf
                                                @method("DELETE")
                                            </form>
                                        </td>
