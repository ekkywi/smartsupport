...
@section("title")
    SmartSupport &mdash; {{ isset($assetStatuses) ? "Edit" : "Tambah" }} Status Asset
@endsection
...
@section("content")
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">{{ isset($assetStatus) ? "Edit" : "Tambah" }} Status Asset</h1>
                        ...
                        <div class="row gy-4">
                            ...
                            <form action="{{ isset($assetStatus) ? route("asset.status.update", $assetStatus->id) : route("asset.status.store") }}" autocomplete="off" class="row gy-4" method="POST">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <label class="form-label text-default fw-semibold" for="name">Nama Status Asset</label>
                                    <input class="form-control" id="name" name="name" placeholder="Nama Status Asset" type="text" value="{{ old("name", isset($assetStatus) ? $assetStatus->name : "") }}">
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <label class="form-label text-default fw-semibold" for="asset_status_tag">Tag Status Asset</label>
                                    <input class="form-control" id="asset_status_tag" name="asset_status_tag" placeholder="Tag Status Asset" type="text" value="{{ old("asset_status_tag", isset($assetStatus) ? $assetStatus->asset_status_tag : "") }}">
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <label class="form-label text-default fw-semibold" for="description">Deskripsi</label>
                                    <textarea class="form-control" id="description" name="description" placeholder="Deskripsi" rows="3">{{ old("description", isset($assetStatus) ? $assetStatus->description : "") }}</textarea>
                                </div>
                                <div class="col-12 d-flex justify-content-end gap-2 mt-4">
                                    ...
                                    <button class="btn btn-primary" type="submit"><i class="ti ti-check"></i> {{ isset($assetStatus) ? "Update" : "Simpan" }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
