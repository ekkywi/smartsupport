...
@section("title")
    SmartSupport &mdash; Tambah Peran
@endsection
...
@section("content")
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Tambah Peran</h1>
                        ...
                        <div class="row gy-4">
                            ...
                            <form action="{{ route("roles.store") }}" class="row gy-4" method="POST">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input class="form-control" id="role_code" name="role_code" placeholder="Kode Peran Baru" type="text">
                                </div>
...
@section("scripts")
    ...
    <script>
        function clearFormInputs() {
            document.querySelectorAll('#role_name, #role_code').forEach(el => el.value = '');
        }
    </script>
    <script>
        function goToIndex() {
