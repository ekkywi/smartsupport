            ...
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb breadcrumb-style2 mb-0">
                        ...
                        <li aria-current="page" class="breadcrumb-item active"><a href="{{ route("sections.edit", $section->id) }}"><i class="ti ti-pencil me-1 fs-15 d-inline-block"></i>Edit Bagian</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="row gy-4">
                            ...
                            <form action="{{ route("sections.update", $section->id) }}" class="row gy-4" method="POST">
                                @csrf
                                @method("PUT")
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <label class="form-label text-default fw-semibold" for="section_name">Nama Bagian</label>
                                    <input class="form-control" id="section_name" name="section_name" placeholder="Nama Bagian Baru" type="text" value="{{ $section->name }}">
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <label class="form-label text-default fw-semibold" for="section_code">Kode Bagian</label>
                                    <input class="form-control" id="section_code" name="section_code" placeholder="Kode Bagian Baru" type="text" value="{{ $section->section_code }}">
                                </div>
                                <div class="col-12 d-flex justify-content-end gap-2 mt-4">
                                    <a class="btn btn-danger" href="{{ route("sections.index") }}"><i class="ti ti-x"></i> Batal</a>
